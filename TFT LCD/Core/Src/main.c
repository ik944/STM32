...
// volatile uint8_t TxBuffer[] = "I'm lee\r\n";
// volatile uint8_t TxBuffer1[] = "TFTLCD_TEST\r\n";
...
/* tft_fn();
 fill(COLOR_WHITE);
 draw_string(0, 8, COLOR_BLACK, 2, "MCSTECH");
 draw_string(0, 40, COLOR_RED, 2, "InKang");
...
//   draw_fast_char(0, 0, 0, COLOR_BLACK, COLOR_YELLOWGREEN);
//  fill_rectangle(0, 0, WIDTH, HEIGHT, COLOR_YELLOWGREEN);
